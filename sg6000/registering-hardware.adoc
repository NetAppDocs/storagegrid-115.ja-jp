...
.手順
. ストレージコントローラシェルフのシャーシのシリアル番号を確認します。
+
...
NOTE: ストレージアプライアンスには複数のシリアル番号があります。ストレージコントローラシェルフのシリアル番号は、アプライアンスのサービスまたはサポートを受けるために登録して使用する必要がある番号です。

. NetApp Support Siteにアクセスします http://["mysupport.netapp.com"^]。
