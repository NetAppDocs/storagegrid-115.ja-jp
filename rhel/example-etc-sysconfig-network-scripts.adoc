...
sidebar: sidebar 
keywords:  
summary: 以下のサンプルファイルを使用して、4つのLinux物理インターフェイスを1つのLACPボンドにまとめ、3つのVLANインターフェイスを確立して、StorageGRID のグリッドネットワーク、管理ネットワーク、およびクライアントネットワークのインターフェイス用にボンドを分割します。 
---
...
[role="lead"]
以下のサンプルファイルを使用して、4つのLinux物理インターフェイスを1つのLACPボンドにまとめ、3つのVLANインターフェイスを確立して、StorageGRID のグリッドネットワーク、管理ネットワーク、およびクライアントネットワークのインターフェイス用にボンドを分割します。
